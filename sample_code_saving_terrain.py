...
Terrain(2 ** 5 + 1, "default", 0.5, 4).save_as_img("test_terrain.png")

# "mybiome" is a custom biome I added at line 8
Terrain(2 ** 5 + 1, "mybiome", 0.5, 4).save_as_img("mybiome.png")

# "desert" is a biome which is included in the library
Terrain(2 ** 5 + 1, "desert", 0.5, 4).save_as_img("desert.png")
